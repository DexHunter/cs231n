...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    out1, cache = affine_relu_forward(X, self.params['W1'], self.params['b1'])
    ...
    #grads['W2'] = np.dot(hidden_layer.T, dscores)#dW2
    ...
    dx1, grads['W1'], grads['b1'] = affine_relu_backward(dx2, cache)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    #dx = {}
    #dx[self.num_layers], grads['W'+str(self.num_layers)], grads['b'+str(self.num_layers)] = affine_backward(dscores, cache[str(self.num_layers)])
    #grads['W'+str(self.num_layers)] += self.reg*self.params['W'+str(self.num_layers)]
    #for i in xrange(self.num_layers-2, -1, -1): #moving backwards
    #    ind = str(i+1)
